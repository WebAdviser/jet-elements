			...
			<cx-vui-tabs
				...
				<cx-vui-tabs-panel
					...
					<cx-vui-input
						...
						description="<?php
							echo sprintf( esc_html__( 'Read more about how to get Instagram Access Token %1$s or %2$s', 'jet-elements' ),
								htmlspecialchars( "<a href='https://elfsight.com/blog/2016/05/how-to-get-instagram-access-token/' target='_blank'>here</a>", ENT_QUOTES ),
								htmlspecialchars( "<a href='https://docs.oceanwp.org/article/487-how-to-get-instagram-access-token' target='_blank'>here</a>", ENT_QUOTES )
							);?>"
						:wrapper-css="[ 'equalwidth' ]"
						size="fullwidth"
					...
					<div
						class="cx-vui-subtitle"
						v-html="'<?php _e( 'APIXU Weather', 'jet-elements' ); ?>'"></div>

					<cx-vui-input
						name="apixu-weather-api-key"
						label="<?php _e( 'APIXU Weather API Key', 'jet-elements' ); ?>"
						description="<?php
							echo sprintf( esc_html__( 'Create own APIXU Weather API key, more info %1$s', 'jet-elements' ),
								htmlspecialchars( "<a href='https://www.apixu.com/api.aspx' target='_blank'>here</a>", ENT_QUOTES )
							);?>"
						:wrapper-css="[ 'equalwidth' ]"
						size="fullwidth"
